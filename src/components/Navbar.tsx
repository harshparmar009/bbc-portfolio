...
export default function Navbar() {
  ...
  return (
    <Element 
    name="top"
    className="bg-blue-400 shadow-md sticky z-50 
    bg-transparent">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              ...
              <Link href="/privacy" className="text-white text-opacity-90 hover:text-opacity-100 px-3 py-2 rounded-md text-xl font-medium">
                  Privacy-Policy
              </Link>
